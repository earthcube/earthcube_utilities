...
* SHACL shapes
* OBIS status for depth
    * bring in the code for this... 
    * sample depth
    * Pieter meeting with Pier Luigi
* reconnect to Kevin re: ERDDAP
* CCHDO has datacatlog and depth, UI needs to address datacatalog, and the release summaries need the depth
    * generate dataset triples for catalogs in CCHDO?
