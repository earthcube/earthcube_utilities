...
Workflow idea: (make a d2 image for this)

1) put the propertyValues URI into vocabulary or ontology
2) check that with SHACL AF with SPARQL to generate the depth values and push out some new triples from that
3) align to the ODIS documentation and also the DeCODER goals
